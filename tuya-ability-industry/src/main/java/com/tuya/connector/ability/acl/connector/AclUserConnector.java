...
import com.tuya.connector.ability.acl.model.AclUser;
import com.tuya.connector.ability.acl.model.AclUserPageQuery;
...
public interface AclUserConnector {
    ...
    AclUser getUserByUid(@Path("space_id")String spaceId,
                         @Path("uid")String uid);

    @POST("/v1.0/iot-03/idaas/spaces/{space_id}/page-user")
    AclPageResult<AclUser> queryUserPage(@Path("space_id")String spaceId,
                                         @Body AclUserPageQuery req);
