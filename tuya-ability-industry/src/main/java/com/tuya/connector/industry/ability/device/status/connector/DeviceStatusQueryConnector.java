package com.tuya.connector.industry.ability.device.status.connector;

import com.tuya.connector.industry.ability.device.status.model.DeviceStatus;
import com.tuya.connector.industry.ability.device.status.model.DeviceStatuses;
